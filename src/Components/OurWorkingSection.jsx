...
export default function WorkSection() {
  return (
    <div className="w-full py-50 px-10 mt-20 bg-[#0B0B0B]">
      <div className="w-full MainSectionInWork  rounded-4xl px-10 relative min-h-[250vh] bg-[#F0F0F0]">
        ...
        <div className="AllProjects absolute bottom-16 pt-5 left-1/2 -translate-x-1/2 w-full min-h-screen bg-[#F0F0F0]">
