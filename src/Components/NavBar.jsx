  ...
  return (
    <nav className="flex  items-center justify-between px-8 py-6 max-w-7xl mx-auto">
      ...
      <div className="hidden md:flex gap-12 text-md font-medium text-gray-300">
        <Link to="/about" className="hover:text-[#07BEC8] font-semibold">
          About us
        </Link>
        ...
        <Link to="/contact" className="hover:text-[#07BEC8] font-semibold">
          Contact
        </Link>
      </div>
      <button
        onClick={() =>
          window.open(
            "https://wa.me/923437117831?text=Hello%20HMK%20CodeWeb!%20I%20would%20like%20to%20inquire%20about%20your%20services.%20%20Am%20Here%20To%20Discuss%20My%20Project%20And%20How%20You%20Can%20Help%20Me.%20Looking%20Forward%20To%20Hearing%20From%20You!",
          )
        }
          ...
          <div className="flex flex-col gap-6 text-sm font-medium text-gray-300">
            ...
            location.pathname === "/contact" ? (
              ...
              <>
                <a
                  href="#Services"
                  className="hover:text-[#07BEC8] font-semibold"
                >
                  What We Do
                </a>
                <a
